    ...
    with get_db() as cur:
        ...
        cur.execute("""
            SELECT pricing_rules.id,
                ...
                pricing_rules.micron_max,
                pricing_rules.film_type,
                packing_types.name AS packing_type_name,
                pricing_rules.roll_weight_min,
                pricing_rules.roll_weight_max,
                pricing_rules.margin_percent
            FROM pricing_rules
