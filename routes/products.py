...
FILM_TYPES = [
    ...
    ("UVI_6m_Standard", "UVI (6 month) Standard"),
    ("UVI_6m_Power", "UVI (6 month) Power"),
    ("UVI_6m_Power_Plus", "UVI (6 month) Power Plus"),
    ("UVI_12m_Standard", "UVI (12 month) Standard"),
    ("UVI_12m_Power", "UVI (12 month) Power"),
    ("UVI_12m_Power_Plus", "UVI (12 month) Power Plus"),
    ("UV_Rigid", "UV&Rigid"),
